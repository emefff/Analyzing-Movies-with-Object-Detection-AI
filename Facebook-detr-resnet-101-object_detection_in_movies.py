...
# NUM_IMAGES = 20
PATH = "/media/drive2/Four Weddings and a Funeral/"
#PATH = "/media/drive2/Lost in Translation/"

MOVIE_TITLE = 'Four Wedding and a Funeral'
...
colors = ['black', 'red', 'green', 'blue', 'cyan', 'yellow'] # for bar
...
plt.savefig('Movie_analysis_'+MOVIE_TITLE+'_thresh='+str(THRESHOLD)+'.jpg', dpi=600)
#plt.show()
